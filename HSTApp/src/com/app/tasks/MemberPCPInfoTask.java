...
/**
 * This async Task is for Member pcp info api call
 */
public class MemberPCPInfoTask extends AsyncTask<String, Void, String> {

	public static String TAG = "";
	String url = "";
	Activity context;
	HashMap<String, Object> postData;
	MemberPCPInformationfragment memberPCPInformationfragment;
	ProgressDialog progressDialog;

	public MemberPCPInfoTask(Activity context,
			MemberPCPInformationfragment memberPCPInformationfragment,
			HashMap<String, Object> postData) {
		this.context = context;
		this.postData = postData;
		this.memberPCPInformationfragment = memberPCPInformationfragment;
	...
	protected String doInBackground(String... url) {
		try {
			HttpPost httppost = new HttpPost(URL.MEMBER_PCP_INFO_URL);
		...
		if (result != null) {
			try {
				...
				if (jsonObject.getString("status").equals("OK")) {
					...
					memberPCPInformationfragment.txtNameData.setText(data
							.getString("FirstName")
							+ " "
							+ data.getString("LastName"));
					memberPCPInformationfragment.txtEmailData.setText(data
							.getString("Email"));
					memberPCPInformationfragment.txtPhoneData.setText(data
							.getString("Phone"));
					memberPCPInformationfragment.txtOfficeHoursData
							.setText(data.getString("WorkingHrs"));
					memberPCPInformationfragment.txtOtherNotesData.setText(data
							.getString("OtherNotes"));
					...
					Utility.showAlert(
							"Error while Getting Member PCP Information",
							context);
				}
			} catch (Exception e) {
				e.printStackTrace();
